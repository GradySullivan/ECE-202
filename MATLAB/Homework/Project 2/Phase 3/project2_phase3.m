% Grady Sullivan
% 11/11/19
% ECE 202 Fall 2019, MATLAB Project 2, Phase 3
% hitting a home run, with air resistance, then exporting data to Excel

% In this phase, a matrix with values for time, x, and y are exported to
...
for n = 1:N % stop at N
   ...
   Fnetx = -fdragcf * v * vx; % net force in x direction
...
export = [t; x; y].';
dlmwrite('project2_phase3.txt',export,'delimiter','\t')
